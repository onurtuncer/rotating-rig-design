# ==============================================================
#  meanline.py — Core meanline analysis function
#
#  References:
#    Dixon & Hall (2014), Chapters 3–5
#    Cumpsty (2004), Chapters 3–4
#    De Haller (1953) — W2/W1 stall criterion
# ==============================================================
...
def meanline_analysis(D_tip, N, PR, eta_is, nu=0.70, h_min=0.05):
    """
    Meanline analysis for a single-stage axial compressor.

    Assumptions
    -----------
    - Swirl-free inlet: Cθ₁ = 0
    - Constant axial velocity through stage
    - Mean streamline representative values only
    ...
    nu     : float — Hub-to-tip ratio r_hub/r_tip [-]
    h_min  : float — Minimum blade height [m]

    Returns
    -------
    dict — All meanline quantities
    """
    # Geometry
    r_tip  = D_tip / 2.0
    r_hub  = nu * r_tip
    ...
    phi      = np.clip(np.sqrt(psi / 2.0), 0.30, 0.75)
    Ca       = phi * U_mean
